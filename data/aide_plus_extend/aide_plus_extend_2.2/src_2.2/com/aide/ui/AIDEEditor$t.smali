...
.method private iK(I)Z
    ...
    .line 1
    :goto_13
    invoke-virtual {p0, p1}, Lcom/aide/ui/views/editor/EditorModel;->getColumnCount(I)I
    ...
    .line 2
    invoke-virtual {p0, v3, p1}, Lcom/aide/ui/views/editor/EditorModel;->charAtColumnLine(II)C
...
.method private sv()V
    ...
    invoke-virtual {v3}, Labcd/jg;->v5()Lcom/aide/ui/views/editor/Position;
    ...
    invoke-virtual {v3}, Lcom/aide/ui/views/editor/Position;->getLine()I

    move-result v6

    invoke-virtual {v3}, Lcom/aide/ui/views/editor/Position;->getColumn()I
    ...
    invoke-virtual {v4, v3}, Labcd/jg;->VH(Lcom/aide/ui/views/editor/Position;)Lcom/aide/ui/views/editor/Position;
...
.method private u9(IIII)Ljava/lang/String;
    ...
    .line 1
    new-instance v1, Lcom/aide/ui/views/editor/SelectedRegion;
    ...
    invoke-direct {v1, v2, v3, v4, v5}, Lcom/aide/ui/views/editor/SelectedRegion;-><init>(IIII)V

    invoke-virtual {p0, v1}, Lcom/aide/ui/views/editor/EditorModel;->Gj(Lcom/aide/ui/views/editor/SelectedRegion;)Ljava/io/Reader;
...
.method public Ak(I)I
    ...
    .line 2
    invoke-virtual {p0, v2, p1}, Lcom/aide/ui/views/editor/EditorModel;->charAtColumnLine(II)C
...
.method public E4(CII)V
    ...
    .line 17
    invoke-static {}, Lcom/aide/ui/ServiceContainer;->ei()Lcom/aide/ui/services/RefactoringService;
...
.method public J0(Lcom/aide/engine/OpenFile;)V
    ...
    .line 1
    :cond_c
    iget-object v2, p1, Lcom/aide/engine/OpenFile;->charArray:[C
    ...
    iput-object v3, p1, Lcom/aide/engine/OpenFile;->charArray:[C

    .line 4
    iget v2, v2, Lcom/aide/ui/views/editor/EditorModel$h;->DW:I

    iput v2, p1, Lcom/aide/engine/OpenFile;->length:I
    :try_end_1e
...
.method public Qq()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/aide/ui/views/editor/AbstractModel;->getEntireDocument()Ljava/io/Reader;
...
.method public ep(IZ)V
    ...
    invoke-virtual {v0}, Labcd/jg;->v5()Lcom/aide/ui/views/editor/Position;
    ...
    invoke-virtual {v0}, Lcom/aide/ui/views/editor/Position;->getLine()I

    move-result v3

    invoke-virtual {v0}, Lcom/aide/ui/views/editor/Position;->getColumn()I
    ...
    invoke-virtual {v1, v0}, Labcd/jg;->VH(Lcom/aide/ui/views/editor/Position;)Lcom/aide/ui/views/editor/Position;
...
.method protected k1(Ljava/lang/String;)V
    ...
    invoke-static {p1, v2}, Lcom/aide/engine/service/CodeModelFactory;->findCodeModel(Ljava/lang/String;Ljava/util/List;)Lcom/aide/codemodel/api/abstraction/CodeModel;
    ...
    invoke-virtual {p0, v2}, Lcom/aide/ui/views/editor/AbstractModel;->addModelListener(Lcom/aide/ui/views/editor/ModelListener;)V
...
.method public ti(IIZ)V
    ...
    .line 5
    invoke-virtual {p0, v1, p1}, Lcom/aide/ui/views/editor/EditorModel;->charAtColumnLine(II)C
    ...
    invoke-virtual {p0, v0, p1, v2, p0}, Lcom/aide/ui/views/editor/EditorModel;->a5(IILjava/io/Reader;Ljava/lang/Object;)Lcom/aide/ui/views/editor/Position;
    :try_end_a6
