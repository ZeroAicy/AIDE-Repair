...
public interface SwitchNameConstants{
	// default false
	public static final String disableFollowExternalClasses = "disableFollowExternalClasses";
	public static final String disableUnifyVirtualMethodName = "disableUnifyVirtualMethodName";
	
	public static final String repairAnalysis = "repairAnalysis";
	public static final String repairEnumAnalysis = "repairEnumAnalysis";
	public static final String repairAIDLAnalysis = "repairAIDLAnalysis";
